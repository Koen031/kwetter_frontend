...
export class JwtDataSource extends LocalDataSource {

  protected conf: ServerSourceConf;

  protected lastRequestCount: number = 0;

  constructor(protected jwtHttp: JwtHttp, conf: ServerSourceConf | {} = {}) {
    super();
  ...
  protected requestElements(): Observable<any> {
    return this.jwtHttp.get(this.conf.endPoint, this.createRequestOptions());
  }
